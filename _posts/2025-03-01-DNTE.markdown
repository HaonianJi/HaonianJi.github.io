...
website: 
details:
  - Proposed the Dynamic-Niche-Based Two-Stage Evolution (DNTE) approach to address suboptimal diversity in the decision space for Multimodal Multiobjective Optimization Problems (MMOPs).
  - Utilized dynamic niche in two stages: first to restrict the dominance range of Pareto domination, and second to refine the decision space distribution.
  - Demonstrated superior performance compared to other evolutionary algorithms on MMF and MMMOP benchmark functions.
---
