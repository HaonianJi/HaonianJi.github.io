...
details:
  - Introduced `MJ-BENCH-VIDEO`, a large-scale video preference benchmark to evaluate video generation on alignment, safety, fineness, coherence, and bias.
  - Proposed `MJ-VIDEO`, a Mixture-of-Experts (MoE) based video reward model for fine-grained reward.
  - Demonstrated superior performance of `MJ-VIDEO` in preference assessment and enhanced alignment in video generation through preference tuning.
---
